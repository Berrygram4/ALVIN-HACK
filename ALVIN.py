...
#Originally Written By Mark_Cornel
...
def logo():
    ...
    os.system('echo -e "\n\né¦ƒåš¢.é¦ƒåš˜.é¦ƒåšš.é¦ƒåšŸ.é¦ƒåš \n\n-----------------------------------------------\n\né‰ƒï¿½ Codded By : BERRY\né‰ƒï¿½ Facebook  : BERRY ALVIN\né‰ƒï¿½ Whatsapp   : +2349025590517\né‰ƒï¿½ Youtube   : No YouTube Channel Yet\n\n-----------------------------------------------" | lolcat')
...
def method_menu():
    ...
    print("\x1b[1;96m[1] B-api (Fast)")

    print("\x1b[1;96m[2] Localhost")
...
def method_menu_select():
    ...
    if afza =="1":
        ...
        print("\t    \033[1;35mSelect valid option \033[0;92m")
...
def login():
    ...
    print("\x1b[1;93m[1] Token login")

    print("\x1b[1;92m[2] ID/Pass login")
...
def login_select():
    ...
    if afza =="1":
        ...
        print("\t    \033[1;32mFB Token Login\033[0;95m")

        print("")

        token = raw_input("\x1b[1;92mPast token here : ")
        ...
        try:
            ...
            print("\t\033[1;32mToken logged in as : "+nm+"\033[0;93m")
...
def login_fb():
	...
	print("\t    \033[1;32mFB ID/PASS Login\033[0;93m")
	...
	if "loc" in q:
		...
		print("\t    \033[1;31mLogged in successfully\033[0;91m")
		...
		print("\t    \033[1;31mUser must verify account before login\033[0;94m")
		...
		print("\t\033[1;31mID/Number/Password may be wrong\033[0;91m")
...
def b_menu():
    ...
    try:
        ...
        print("\t    \033[1;31mðŸ”ŒTurn on mobile data OR wifiðŸ”Œ \033[0;95m")

        print("")

        time.sleep(1)

        raw_input("\x1b[1;92mPress enter to try again \033[0;92m")
    ...
    print("\x1b[1;91m[3] View token")

    print("\x1b[1;93m[4] Find date of birth")

    print("\x1b[1;91m[5] Return method menu")

    print("\x1b[1;93m[6] Logout")
...
def b_menu_select():
	...
	if select =="1":
		...
		try:
		    ...
		    print("\n\t    \033[1;31m Logged in id has checkpoint\033[0;93m")
		...
		idt = raw_input("\x1b[1;95mPut Id/user : ")
		...
		try:
		    ...
		    print("\n\t    \033[1;31m Logged in id has checkpoint\033[0;91m")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\x1b[1;92m[ALVIN-CP] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;92m[ALVIN Hacked] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\x1b[1;93m[ALVIN-CP] "+uid+" | "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;92m[ALVIN-OK] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
...
def dob_select():
	...
	if select =="1":
		...
		#print('[é‰æ® Looking For Accounts')
	...
	print("\x1b[1;91mThe Process has started")
...
def dob():
    ...
    print("\x1b[1;91mAccount ID : "+idt)

    print("\x1b[1;91mDOB : "+dobs)
...
def conf():
    ...
    ol = raw_input("\x1b[1;92mDo you want to find again (y/n) ")
...
def l_menu():
    ...
    try:
        ...
        print("\t    \033[1;31mTurn on mobile data OR wifi\033[0;91m")
...
def l_menu_select():
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					...
					if "loc" in q:
						...
						print("\033[1;32m[Successful] \033[1;30m"+uid+" | "+pass2+"\033[0;91m")
	...
	print("\x1b[1;91mThe process has completed")
